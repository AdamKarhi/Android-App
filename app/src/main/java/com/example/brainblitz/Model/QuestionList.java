   ...
   public ArrayList<Question> dayQuestionList=new ArrayList<Question>();
    ...
    public void addSimilerQuestion(Context context){
        ...
        if(getLanguage(context).equals("eng")){
            ...
            similerQuestionList.add(new Question("YUKARIDA GÖSTERİLEN AYNI AYIYI BULUN",R.drawable.bear05,optionArrayList));
            similerQuestionList.add(new Question("YUKARIDA GÖSTERİLEN AYNI KEDİYİ BULUN",R.drawable.cat04,optionArrayList1));
            similerQuestionList.add(new Question("YUKARIDA GÖSTERİLEN AYNI ASLANI BULUN",R.drawable.lion01,optionArrayList2));
            similerQuestionList.add(new Question("YUKARIDA GÖSTERİLEN AYNI MAYMUNU BULUN",R.drawable.monkey01,optionArrayList3));
            similerQuestionList.add(new Question("YUKARIDA GÖSTERİLEN AYNI ZEBRAYI BULUN",R.drawable.zebra03,optionArrayList4));
        }
